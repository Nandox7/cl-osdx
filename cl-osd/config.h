...
//#define ALARM_BATT2_LOW 1.00 //Warn if below this level (in volt)
#define ALARM_RSSI_LOW 40 //Warn if below this level (in %)
...
#endif
#define SENSOR_RSSI_MAX_VOLTAGE 2.62 //(Max two digits after the dot)
#define SENSOR_RSSI_MIN_VOLTAGE 0.00
...
#define SCREEN_AND_SENSOR_UPDATES_PER_SEC 3
...
#else //PAL
//#define TEXT_TRIG_LINES_LIST 90, 116, 170, 205, 255, 280 // Must be rising line numbers!
#define TEXT_TRIG_LINES_LIST 266, 280 // Must be rising line numbers!
#endif //COLORSYSTEM_NTSC
